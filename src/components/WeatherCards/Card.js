    ...
    return (
        <>
            ...
            <div className="card-wrapper"> 
                ...
                <p className='card-wrapper__description'>Sunrise: {timeConverter()} AM</p>
            </div>
            <div className="card-wrapper">
                <div className='card-wrapper__header'>
                    <img src={Wind}/>
                ...
                <div className='speed-wrapper'>
                    ...
                    <div className='speed-text'>
                        <p className='speed-title'>{Math.round(weather.speed)}</p> 
            ...
            <div className="card-wrapper">
                ...
                <p className='card-wrapper__degree'>{Math.round(weather.feels_like)}°</p>
                <h3 className='card-wrapper__description'>Similar to the actual temperature</h3>
            </div>
            <div className="card-wrapper">
                <div className='card-wrapper__header'>
                    <img src={Humidity}/>
            ...
            <div className="card-wrapper">
                ...
                <p className='card-wrapper__degree'>{weather.visibility / 1000} KM</p>
                <h3 className='card-wrapper__description'>Visibility is good</h3>
            </div>    
        </>               
    )
}
